...
/***/ function(module, exports, __webpack_require__) {
	...
	var _foursquare = __webpack_require__(2);

	var _foursquare2 = _interopRequireDefault(_foursquare);

	var _bootstrapSass = __webpack_require__(5);
	      ...
	      */
			...
			value: function addEvents() {
				...
				document.querySelector('#searchForm').addEventListener('submit', function (e) {
					if (_this2.searchBox.value !== _this2.currentQuery) {
						_this2.searchType = 'search';
						_this2.list.classList.remove('show');
						_this2.loader.classList.add('show');
				...
				this.limit.addEventListener('input', function () {
					_this2.callAPI.call(_this2, ENDPOINT_EXPLORE, exploreParams);
				});
			}
